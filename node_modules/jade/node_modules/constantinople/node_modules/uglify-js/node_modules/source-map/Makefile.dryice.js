...
function buildBrowser() {
  console.log('\nCreating bootstrap/source-map.js');
  ...
  copy({
    ...
    dest: 'bootstrap/source-map.js'
  });
}

function buildBrowserMin() {
  console.log('\nCreating bootstrap/source-map.min.js');

  copy({
    source: 'bootstrap/source-map.js',
    filter: copy.filter.uglifyjs,
    dest: 'bootstrap/source-map.min.js'
  });
}

function buildFirefox() {
  console.log('\nCreating bootstrap/SourceMap.jsm');
  ...
  copy({
    ...
    dest: 'bootstrap/SourceMap.jsm'
  });

  // Create bootstrap/test/Utils.jsm
  console.log('\nCreating bootstrap/test/Utils.jsm');
  ...
  testFiles.forEach(function (testFile) {
    console.log('\nCreating', path.join('bootstrap', 'test', testFile.replace(/\-/g, '_')));
    ...
    copy({
      ...
      dest: path.join('bootstrap', 'test', testFile.replace(/\-/g, '_'))
    });
  });
}
